/**
 * @todo - @7sne
 * @description - This is a duplicate of an already existing function in the
 * core logic of the app. This is a temporary solution.
 */
export function gradientImageData(canvasContext: any, width: number, height: number, rgb: any[], rgbPositions: any[]) {
